...
RSpec.describe Api::V1::PostsController, type: :controller do
    ...
    context "unauthenticated user" do
        ...
        it "GET show returns http success" do
            get :show, my_topic: my_topic.id, id: my_post.id
            expect(response).to have_http_status(:success)
        end
        
        it "PUT update returns http unauthenticated" do
            put :update, my_topic: my_topic.id, id: my_post.id, post: { title: "Post Title", body: "This is a post body." }
    ...
    context "authenticated and authorized users" do
        ...
        describe "PUT udpate" do
            before { put :update, my_topic: my_topic.id, id: my_post.id, post: { title: @new_post.title, body: @new_post.body } }
        ...
        describe "POST create post" do   #Britt
